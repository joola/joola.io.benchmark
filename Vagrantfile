...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "joola-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/joola2"
  #   chef.validation_client_name = "joola2-validator"
  #   chef.validation_key_path = ".chef/joola2-validator.pem"
  # end
end
